...
ファーストビューに出るヘッダー画像と、あひるアイコンの読み込みが遅かったので、いくつか手を入れて改善しました。

![](/images/faster-cover-and-icon-performance/after.gif)
...
![](/images/faster-cover-and-icon-performance/before.gif)
